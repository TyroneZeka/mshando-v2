...
# Check services
services=("eureka:8761:Eureka Server" "gateway:8080:API Gateway" "user:8081:User Service" "task:8082:Task Service" "bidding:8083:Bidding Service" "payment:8084:Payment Service")
